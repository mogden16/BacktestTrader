...
RUN_LIVE_TRADER = os.getenv('RUN_LIVE_TRADER') == "True"
...
class ApiTrader(Tasks, OrderBuilder):
    ...
    def sendOrder(self, trade_data, strategy_object, direction):
        ...
        # obj['Volume'] = trade_data['Volume']

        # obj['Open_Interest'] = trade_data['Open_Interest']
        ...
        response = requests.post(os.getenv('DISCORD_WEBHOOK'), json=discord_queue_message_to_push)
    ...
    def pushOrder(self, queue_order, spec_order, data_integrity="Reliable"):
        ...
        if asset_type == "OPTION":
            ...
            # obj["Volume"] = queue_order["Volume"]
            #
            # obj["Open_Interest"] = queue_order["Open_Interest"]
        ...
        if direction == "OPEN POSITION":
            ...
            discord_message_to_push = {"content": f":rocket: TradingBOT just opened \n Side: {side} \n Symbol: {pre_symbol} \n Qty: {shares} \n Price: ${price} \n Strategy: {strategy} \n Asset Type: {asset_type} \n Date: {getDatetime()} \n :rocket: Account Position: {'Live Trade' if self.RUN_LIVE_TRADER else 'Paper Trade'}"}
            ...
            discord_message_to_push = {"content": f":closed_book: TradingBOT just closed \n Side: {side} \n Symbol: {pre_symbol} \n Qty: {position['Qty']} \n Entry Price: ${position['Entry_Price']} \n Entry Date: {position['Entry_Date']} \n Exit Price: ${price} \n Exit Date: {getDatetime()} \n Strategy: {strategy} \n Asset Type: {asset_type} \n :closed_book: Account Position: {'Live Trade' if self.RUN_LIVE_TRADER else 'Paper Trade'}"}
        ...
        # print("POSTED TO DISCORD: %s" % discord_message_to_push)
